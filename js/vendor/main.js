...
$(window).load(function() {
    ...
    setTimeout(function() {
        loader_p.text("Initializing Wake Sequence").removeClass('hide');
    }, 2000);
    setTimeout(function() {
        loader_p.addClass('hide');
    ...
    var typed = new Typed('#guide-text p', {
        strings: ["Hi.", "I'll be your guide today.", "I'm just pixels and code.. but I can be useful.", "Have a look around."],
        typeSpeed: 36,
        backDelay: 1400,
        backSpeed: 15,
        startDelay: 5500,
    ...
    console.log('Anthropomorph Initialized.');
